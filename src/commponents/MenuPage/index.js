        ...
        <div className="ui stackable four column grid menuPageStyleContainer">
          <div className="menuLandingText">
            ...
            <div className="menuParagrph">
              <p>
                Travis Scot, our Cocktail expert in our Restaurant has prepared
                some delicious cocktails for every taste. Try some of our
                Mojitos with homegrown mint made from fresh ingredients or some
                other refreshing drink. Cheers!
              </p>
            </div>
          </div>
